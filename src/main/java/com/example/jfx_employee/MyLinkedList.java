...
public class MyLinkedList {
    ...
    public int linear_search(String text) {
        ...
        while(pointer != null) {
            if(pointer.value.name.equals(text) ||  (pointer.value.emp_num+"").equals(text)) {
                return counter;
            }
            pointer = pointer.next;
            counter++;
    ...
    public Node binary_search(String value) {
        ...
        do
        {
            ...
            if (mid == null)
                return null;
            if (mid.value.getEmp_num() == Integer.parseInt(value))
                return mid;
            else if (mid.value.getEmp_num() < Integer.parseInt(value))
            {
                start = mid.next;
            }
   ...
   /* public void bubble_sort() {
    ...
    public void bubble_sort() {
        if (filled > 1) {
            ...
            do {
                ...
                while ( next != null ) {
                    if (current.value.getEmp_num() > next.value.getEmp_num()) {
    ...
    public void selectionSort()
    {
        ...
        while (auxiliary != null)
        {
            ...
            while (temp != null)
            {
                if (node.value.getEmp_num() > temp.value.getEmp_num())
                {
                    node = temp;
                }
                // Visit to next node
            ...
            if (auxiliary.value.getEmp_num() > node.value.getEmp_num())
            {
